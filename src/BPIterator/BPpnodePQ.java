 ...
 * @throws InvalidSlotNumberException 
  ...
  abstract public void  enq(BPpnode  item) 
           throws IOException, UnknowAttrType, BasicPatternUtilsException, InvalidSlotNumberException, InvalidLabelSizeException, LHFException, LHFDiskMgrException, LHFBufMgrException, Exception;      
 ...
 * @throws InvalidSlotNumberException 
   * @exception TupleUtilsException error in tuple compare routines
   */  
  public boolean BPpnodeEQ(BPpnode a, BPpnode b) throws InvalidSlotNumberException, InvalidLabelSizeException, LHFException, LHFDiskMgrException, LHFBufMgrException, Exception {
