...
public abstract class BPpnodePQ
{
    ...
    abstract public void  enq(BPpnode  item)
            throws IOException, UnknowAttrType, BasicPatternUtilsException, InvalidSlotNumberException,
             Exception;
     ...
     * @exception TupleUtilsException error in tuple compare routines
     */
    public boolean BPpnodeEQ(BPpnode a, BPpnode b) throws InvalidSlotNumberException,
             Exception {
