 ...
 * Implements the <code>Quadrupleenq</code> and the <code>deq</code> functions.
 */
public class QuadruplepnodeSplayPQ extends QuadruplepnodePQ
{
    ...
    /**
     * class constructor.
     * @param order   the order of sorting (subject,predicate,confidence or subject,predicate or etc)
     */
     ...
     */
    public void Quadrupleenq(Quadruplepnode item) throws IOException, UnknowAttrType, TupleUtilsException
    {
        count ++;
