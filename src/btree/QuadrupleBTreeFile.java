...
public class QuadrupleBTreeFile extends QuadrupleIndexFile
   ...
   */
	...
	curEntry=pageLeaf.getFirst(startqid);
      ...
      // ASSERTIONS:
      // - curkey, curQid: contain the first record on the
  ...
  /*
   *  Status BTreeFile::NaiveDelete (const void *key, const QID qid)
   * 
  ...
  private KeyClass _Delete ( KeyClass key,
	...
	QID delQid;
	// for all records with key equal to 'key', delete it if its qid = 'qid'
