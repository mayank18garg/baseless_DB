...
//import btree.*;
   ...
   */
class LabelHeapBTreeHeaderPage extends LHFPage {
   ...
   */
  public LabelHeapBTreeHeaderPage(PageId pageno)
  ...
  public LabelHeapBTreeHeaderPage(Page page) {
   ...
   */
  public LabelHeapBTreeHeaderPage( )
    throws ConstructPageException
    {
      super();
      try{
