...
class BMDriver extends TestDriver implements GlobalConst {
  ...
  protected boolean test1 () {
    ...
    // int mayankpages = SystemDefs.JavabaseBM.getNumBuffers();
    // numPages = 0;
    Page pg = new Page(); 
    PageId pid; 
    PageId lastPid;
    PageId firstPid = new PageId(); 
    // System.out.print("No. of unpinnedPages in mayank's1 : " + numPages + "\n");
    // System.out.print("No. of TotalPages in mayank's1 : " + mayankpages + "\n");
    ...
    // System.out.print("No. of unpinnedPages in mayank's1 : " + SystemDefs.JavabaseBM.getNumUnpinnedBuffers() + "\n");
    // System.out.print("No. of TotalPages in mayank's1 : " + SystemDefs.JavabaseBM.getNumBuffers() + "\n");
  ...
  protected boolean test2 () {
    ...
    PageId firstPid = new PageId();
    boolean status = OK;
    // System.out.print("No. of Pages in mayank's2 : " + numPages + "\n");
